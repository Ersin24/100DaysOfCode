...
const firstButtonElement = window.document.querySelector("button"); //Eşleşen ilk öğeyi döndürür
const secondButtonElement = window.document.querySelector("#change-bg-btn");
...
const firstParagraphElement = window.document.body.children[2].children[1];
console.log(firstParagraphElement);
// const thirdParagraphElement = window.document.body.children[2].children[3];
...
function changeBackgroundColor(event) {
  ...
  // firstParagraphElement.className = 'blue';
